...
class R5ViewSet(viewsets.ModelViewSet):
    serializer_class = R5Serializer
    authentication_classes = (
        authentication.SessionAuthentication,
        authentication.TokenAuthentication,
    )
    queryset = R5.objects.all()
...
class R56ViewSet(viewsets.ModelViewSet):
    serializer_class = R56Serializer
    authentication_classes = (
        authentication.SessionAuthentication,
        authentication.TokenAuthentication,
    )
...
class XXX1ViewSet(viewsets.ModelViewSet):
    serializer_class = XXX1Serializer
    authentication_classes = (
        authentication.SessionAuthentication,
        authentication.TokenAuthentication,
    )
